    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          ...
          Next step will wire Mailchimp + (optional) Supabase.
        </p>
      </header>
      ...
      <section className="rounded-2xl border p-5">
        ...
        <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2">
          <div>
            ...
            <input className="w-full rounded-xl border px-3 py-2 text-sm dark:bg-zinc-900" value={email} onChange={e=>setEmail(e.target.value)} required />
          </div>
          <div>
            <label className="text-sm font-medium">Name (optional)</label>
            <input className="w-full rounded-xl border px-3 py-2 text-sm dark:bg-zinc-900" value={name} onChange={e=>setName(e.target.value)} />
          </div>
          ...
          <div className="sm:col-span-2 grid grid-cols-2 gap-3">
            ...
            <div className="text-right">
              <button
                className="rounded-2xl bg-brand text-white px-4 py-2"
